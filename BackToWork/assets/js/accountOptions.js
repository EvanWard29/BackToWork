$(function(){
    ...
    $('#btnSaveEmail').click(async function(){
        ...
        if(newEmail === ""){
            ...
            if(validateEmail(newEmail) === false){
                ...
                //Email does contain @ - Check if emails match
        ...
        if(CryptoJS.AES.decrypt(password, "CHEESEBURGER").toString(CryptoJS.enc.Utf8) === ""){
            ...
            await $.post("/BackToWork/src/controller/loginUser.php", {
        ...
        if(emailErr !== true && passwordErr !== true){
            //Process Change
            $.post("/BackToWork/src/controller/changeEmail.php",{
    ...
    $('#btnSavePassword').click(async function(){
        ...
        if(emailErr !== true && passwordErr !== true){
            ...
            $.post("/BackToWork/src/controller/changePassword.php",{
                email: email,
